...
_lr_productions = [
  ...
  ('modulo -> MODULO ID ENDSENTENCE','modulo',3,'p_modulo','AnalizadorSin.py',27),
  ('funcionmain -> DEFINE PMAIN LPARENT RPARENT LCORCHE instrucciones RCORCHE','funcionmain',7,'p_funcionmain','AnalizadorSin.py',32),
  ('librerias -> IMPORTA ID ENDSENTENCE librerias','librerias',4,'p_librerias','AnalizadorSin.py',35),
  ('librerias -> empty','librerias',1,'p_librerias_emp','AnalizadorSin.py',38),
  ('instrucciones -> declaraciones','instrucciones',1,'p_instrucciones_dec','AnalizadorSin.py',41),
  ('instrucciones -> ciclos','instrucciones',1,'p_instrucciones_cic','AnalizadorSin.py',44),
  ('instrucciones -> condicionales','instrucciones',1,'p_instrucciones_con','AnalizadorSin.py',47),
  ('instrucciones -> expresiones ENDSENTENCE','instrucciones',2,'p_instrucciones_exp','AnalizadorSin.py',50),
  ('instrucciones -> instrucciones','instrucciones',1,'p_instrucciones_ins','AnalizadorSin.py',53),
  ('instrucciones -> empty','instrucciones',1,'p_instrucciones_emp','AnalizadorSin.py',56),
  ('declaraciones -> VAR ID ENDSENTENCE','declaraciones',3,'p_declaraciones','AnalizadorSin.py',59),
  ('declaraciones -> VAR ID ASIGNA expresiones ENDSENTENCE','declaraciones',5,'p_declaraciones_exp','AnalizadorSin.py',62),
  ('condicionales -> SI LPARENT expresiones RPARENT LCORCHE instrucciones RCORCHE sinocondicion','condicionales',8,'p_condicionales','AnalizadorSin.py',65),
  ('sinocondicion -> SINO LCORCHE instrucciones RCORCHE','sinocondicion',4,'p_sinocondicion','AnalizadorSin.py',68),
  ('sinocondicion -> empty','sinocondicion',1,'p_sinocondicion_emp','AnalizadorSin.py',71),
  ('ciclos -> PARA LPARENT ID COMA ID RPARENT EN LPARENT condicionfor RPARENT LCORCHE instrucciones RCORCHE','ciclos',13,'p_ciclos','AnalizadorSin.py',74),
  ('condicionfor -> expresiones','condicionfor',1,'p_condicionfor_exp','AnalizadorSin.py',77),
  ('expresiones -> expresiones SUMA terminos','expresiones',3,'p_expression_plus','AnalizadorSin.py',80),
  ('expresiones -> expresiones IGUALDAD terminos','expresiones',3,'p_expression_equal','AnalizadorSin.py',84),
  ('expresiones -> expresiones RESTA terminos','expresiones',3,'p_expression_minus','AnalizadorSin.py',88),
  ('expresiones -> terminos','expresiones',1,'p_expression_term','AnalizadorSin.py',92),
  ('terminos -> terminos MUTIPLICA factor','terminos',3,'p_term_times','AnalizadorSin.py',96),
  ('terminos -> terminos DIVIDE factor','terminos',3,'p_term_div','AnalizadorSin.py',100),
  ('terminos -> factor','terminos',1,'p_term_factor','AnalizadorSin.py',104),
  ('factor -> NUMERO','factor',1,'p_factor_num','AnalizadorSin.py',108),
  ('factor -> ID','factor',1,'p_factor_ID','AnalizadorSin.py',112),
  ('factor -> LPARENT expresiones RPARENT','factor',3,'p_factor_expr','AnalizadorSin.py',116),
  ('empty -> <empty>','empty',0,'p_empy','AnalizadorSin.py',120),
]
